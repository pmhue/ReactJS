    ...
    return (
        <div className='container'>
            ...
            <div className='d-flex'>
                ...
                <div className='w-50'>
                    <button className='mx-2 btn btn-danger' onClick={() => changeColor('red')}>
                        Red color
                    </button>
                    <button className='mx-2 btn btn-dark' onClick={() => changeColor('black')}>
                        Black color
                    </button>
                    <button className='mx-2 btn btn-secondary' onClick={() => changeColor('silver')}>
                        Silver color
                    </button>
                    <button className='mx-2 btn btn-primary' onClick={() => changeColor('steel')}>
                        Steel color
                    </button>
                </div>
            </div>
